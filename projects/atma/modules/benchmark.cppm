...
namespace atma::bench
{
	...
	template <typename T>
	struct relistify<T, std::void_t<decltype(T::listify())>>
	{
		using type = decltype(T::listify());
	};
