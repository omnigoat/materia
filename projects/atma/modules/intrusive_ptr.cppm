...
export namespace atma
{
	...
	struct intrusive_ptr
	{
		using deleter_type = std::default_delete<T>; //policies::retrieve_t<use_deleter,
			//policies::default_<>,
			//Policies...>;

		using refcount_traits = ref_counted_traits<T>; //policies::retrieve_t<use_ref_counting_semantics,
			//policies::default_<>,
			//Policies...>;

		using pointer_traits = intrusive_ptr_traits<T>; //policies::retrieve_t<use_pointer_semantics,
			//policies::default_<>,
			//Policies...>;
