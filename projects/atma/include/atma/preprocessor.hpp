...
#else
#  define ATMA_PP_INTERNAL_CAT2(a, b) a##b
#  define ATMA_PP_CAT(a, b) ATMA_PP_INTERNAL_CAT2(a, b)
#endif

#if !defined(_MSVC_TRADITIONAL) || _MSVC_TRADITIONAL
#else
	#define ATMA_PP_INTERNAL_CHOOSER_0_N_ii(a, b, c, d, e, f, g, h, ...) h
	#define ATMA_PP_INTERNAL_CHOOSER_0_N(...) ATMA_PP_INTERNAL_CHOOSER_0_N_ii(__VA_ARGS__ __VA_OPT__(,) N, N, N, N, N, N, N, 0)
	#define ATMA_PP_OVERLOAD_0_N(prefix, ...) ATMA_PP_CAT(prefix, ATMA_PP_INTERNAL_CHOOSER_0_N(__VA_ARGS__))
	#define ATMA_PP_OVERLOAD_CALL_0_N(prefix, ...) ATMA_PP_CAT(prefix, ATMA_PP_INTERNAL_CHOOSER_0_N(__VA_ARGS__))(__VA_ARGS__)
#endif
...
#define FOR_EACH_COMBINATION_m2(f, ...) f(__VA_ARGS__)
...
#define FOR_EACH_COMBINATION(fn, d, tupleseq) \
	BOOST_PP_SEQ_FOR_EACH_I(FOR_EACH_COMBINATION_m, (fn, d), tupleseq)
...
//    GENERATE_TEMPLATE_TYPE_COMBINATIONS(dragon_t, (int, float)(string, char*))
//
#define FOR_EACH_TEMPLATE_TYPE_COMBINATION_F(r,d,i,x) d(i, BOOST_PP_TUPLE_REM_CTOR(x))
